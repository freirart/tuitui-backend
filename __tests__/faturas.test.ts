...
// describe.skip("Authorization accessing private routes", () => {
...
// describe.skip("GET /faturas/:faturaId", () => {
...
// describe.skip("DELETE /faturas/:faturaId", () => {
//     it("should return an error if 'faturaId' param is invalid", async () => {
//         const user = await factories.create('User');
...
// describe.skip("GET /faturas/pagination/:pageNumber", () => {
